...
from typing import (Any, Generic, MutableSequence, TypeVar,  # noqa: Y027
                    overload)

from _typeshed import ReadableBuffer, Self, SupportsRead, SupportsWrite
from typing_extensions import Literal, SupportsIndex, TypeAlias

_IntTypeCode = Literal["b", "B",
                       "h", "H", "i", "I", "l", "L", "q", "Q"]
...
class array(MutableSequence[_T], Generic[_T]):
  ...
  @overload
  def __init__(self: array[int], __typecode: _IntTypeCode,
               __initializer: bytes | Iterable[int] = ...) -> None: ...

  @overload
  def __init__(self: array[float], __typecode: _FloatTypeCode,
               __initializer: bytes | Iterable[float] = ...) -> None: ...

  @overload
  def __init__(self: array[str], __typecode: _UnicodeTypeCode,
               __initializer: bytes | Iterable[str] = ...) -> None: ...

  @overload
  def __init__(self, __typecode: str,
               __initializer: Iterable[_T]) -> None: ...
  ...
  if sys.version_info >= (3, 10):
    def index(self, __v: _T, __start: int = ...,
              __stop: int = ...) -> int: ...
  else:
  ...
  def __iadd__(self: Self, __x: array[_T]
