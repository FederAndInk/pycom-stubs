...
if sys.version_info >= (3, 11):
  def a2b_base64(__data: _AsciiBuffer, *,
...
def b2a_qp(data: ReadableBuffer, quotetabs: bool = ...,
           istext: bool = ..., header: bool = ...) -> bytes: ...
...
if sys.version_info >= (3, 8):
  ...
  def b2a_hex(data: ReadableBuffer, sep: str | bytes = ...,
              bytes_per_sep: int = ...) -> bytes: ...
  def hexlify(data: ReadableBuffer, sep: str | bytes = ...,
              bytes_per_sep: int = ...) -> bytes: ...
