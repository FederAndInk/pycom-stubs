...
class _TypedDict(Mapping[str, object], metaclass=abc.ABCMeta):
    ...
    if sys.version_info >= (3, 9):
        def __or__(self: _typeshed.Self,
                   __value: _typeshed.Self) -> _typeshed.Self: ...
        def __ior__(self: _typeshed.Self,
                    __value: _typeshed.Self) -> _typeshed.Self: ...
...
if sys.version_info >= (3, 11):
    ...
    class NamedTuple(tuple[Any, ...]):
        ...
        @overload
        def __init__(self, typename: str, fields: None = ...,
                     **kwargs: Any) -> None: ...

        @classmethod
        def _make(cls: type[_typeshed.Self],
                  iterable: Iterable[Any]) -> _typeshed.Self: ...
        if sys.version_info >= (3, 8):
            def _asdict(self) -> dict[str, Any]: ...
        else:
            def _asdict(self) -> collections.OrderedDict[str, Any]: ...

        def _replace(self: _typeshed.Self, **
                     kwargs: Any) -> _typeshed.Self: ...
