...
class _Char_callback_data(NamedTuple):
    event: int
    value: bytes
...
class GATTCCharacteristic:
    ...
    def read_descriptor(self, uuid: int | bytes) -> None | bytes:
        '''
...
class GATTSCharacteristic:
    ...
    def value(self, value: int | str | bytes | None = None) -> None | int | str | bytes:
        ...
...
class BluetoothServerService:
    ...
    def characteristic(self, uuid, *, permissions: int | None = None, properties: int | None = None, value: int | str | bytes | None = None) -> GATTSCharacteristic:
        '''
...
class _Ble_adv_data(NamedTuple):
    mac: bytes
    addr_type: int
    adv_type: int
    rssi: int
...
class Bluetooth:
    ...
    @overload
    def modem_sleep(self) -> bool:
        ...

    @overload
    def modem_sleep(self, enable: bool) -> None:
        ...

    def modem_sleep(self, enable: bool | None = None) -> bool | None:
        ...
    ...
    def __init__(self, id=0, *, antenna=INT_ANT, modem_sleep=True, pin: int | None = None, privacy=True, secure_connections=True, mtu=200):
        '''
    ...
    def init(self, *, id=0, antenna=INT_ANT, modem_sleep=True, pin: int | None=None, privacy=True, secure_connections=True, mtu=200):
        '''
    ...
    def get_adv(self) -> _Ble_adv_data:
        '''
    ...
    def get_advertisements(self) -> list[_Ble_adv_data]:
        '''
    ...
    def resolve_adv_data(self, data: bytes, data_type: int) -> str | None:
        '''
    ...
    def set_advertisement(self, *, name : str | None = None, manufacturer_data : str | None = None, service_data=None, service_uuid: bytes | int | None = None):
        '''
    ...
    def set_advertisement_params(self, *, adv_int_min=0x20, adv_int_max=0x40, adv_type=ADV_TYPE_IND, own_addr_type=ADV_BLE_ADDR_TYPE_PUBLIC, channel_map=ADV_CHNL_ALL, adv_filter_policy=ADV_FILTER_ALLOW_SCAN_ANY_CON_ANY):
        '''
    ...
    def advertise(self, Enable: bool):
        '''
        Start or stop sending advertisements. The `set_advertisement()` method must have been called prior to this one.
        '''
        ...

    def service(self, uuid: int | str | bytes, isprimary=True, nbr_chars=1, start=True) -> BluetoothServerService:
        '''
    ...
    @overload
    def tx_power(self, type: int) -> int:
        '''
    ...
    @overload
    def tx_power(self, type: int, level: int) -> None:
        '''
    ...
    def tx_power(self, type: int, level: int | None = None) -> int | None:
        '''
