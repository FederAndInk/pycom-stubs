...
class int:
  ...
  def __new__(
      cls: Type[_T],
      x: Union[str, bytes, SupportsInt,
               _SupportsIndex, _SupportsTrunc] = ...,
  ) -> _T: ...

  @overload
  def __new__(cls: Type[_T], x: Union[str, bytes,
              bytearray], base: int = 0) -> _T: ...
  ...
  @overload
  def __pow__(self, __x: Literal[2],
              __modulo: Optional[int] = ...) -> int: ...
...
class str(Sequence[str]):
  ...
  def rsplit(self, sep: Optional[str] = ...,
             maxsplit: int = ...) -> List[str]: ...

  def rstrip(self, __chars: Optional[str] = ...) -> str: ...

  def split(self, sep: Optional[str] = ...,
            maxsplit: int = ...) -> List[str]: ...
...
class bytes(ByteString):
  ...
  @overload
  def __new__(cls: Type[_T], string: str,
              encoding: str, errors: str = ...) -> _T: ...
  ...
  def replace(self, __old: bytes, __new: bytes,
              __count: int = ...) -> bytes: ...
  ...
  def split(self, sep: Optional[bytes] = ...,
            maxsplit: int = ...) -> List[bytes]: ...
  ...
  def __add__(self, s: bytes | str) -> bytes: ...
  def __mul__(self, n: int) -> bytes: ...
  def __rmul__(self, n: int) -> bytes: ...
  def __mod__(self, value: Any) -> bytes: ...
  # Incompatible with Sequence.__contains__
  def __contains__(self, o: Union[int, bytes, str]) -> bool: ...  # type: ignore
  def __eq__(self, x: object) -> bool: ...
  def __ne__(self, x: object) -> bool: ...
...
class bytearray(ByteString):
  ...
  @overload
  def __setitem__(
      self, s: slice, x: Union[Iterable[int], bytes]) -> None: ...
...
class list(MutableSequence[_T], Generic[_T]):
  ...
  def index(self, __value: _T, __start: int = ...,
            __stop: int = ...) -> int: ...
...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
  ...
  @overload
  def __init__(
      self, iterable: Iterable[Tuple[_KT, _VT]], **kwargs: _VT) -> None: ...
  ...
  @overload
  def update(self, __m: Iterable[Tuple[_KT, _VT]],
             **kwargs: _VT) -> None: ...
...
class range(Sequence[int]):
  ...
  @overload
  def __init__(
      self, start: _SupportsIndex, stop: _SupportsIndex, step: _SupportsIndex = ...
  ) -> None: ...
  def __len__(self) -> int: ...
  def __contains__(self, o: object) -> bool: ...
  def __iter__(self) -> Iterator[int]: ...
...
@overload
def iter(__function: Callable[[], Optional[_T]],
...
def max(__iterable: Iterable[_T], *,
        key: Callable[[_T], SupportsLessThanT]) -> _T: ...
