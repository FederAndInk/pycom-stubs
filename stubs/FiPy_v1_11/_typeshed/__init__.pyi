...
OpenTextModeWriting = Literal["w",
                              "wt", "tw", "a", "at", "ta", "x", "xt", "tx"]
...
OpenBinaryModeReading = Literal["rb",
                                "br", "rbU", "rUb", "Urb", "brU", "bUr", "Ubr"]
...
if sys.version_info >= (3, 8):
  ...
  # stable
  WriteableBuffer = bytearray | memoryview | array.array[
...
class structseq(Generic[_T_co]):
  ...
  def __new__(cls: type[Self], sequence: Iterable[_T_co],
